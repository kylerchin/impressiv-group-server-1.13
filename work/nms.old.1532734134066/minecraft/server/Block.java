...
public class Block implements IMaterial {
    ...
    public static Block getByName(String s) {
        try {
            ...
            Block.d.warn("Invalid blockstate: {}", s, illegalargumentexception);
        }
    ...
    public static IBlockData a(IBlockData iblockdata, IBlockData iblockdata1, GeneratorAccess generatoraccess, BlockPosition blockposition) {
        VoxelShape voxelshape = VoxelShapes.b(iblockdata.h(generatoraccess, blockposition), iblockdata1.h(generatoraccess, blockposition), OperatorBoolean.ONLY_SECOND).a((double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ());
        List list = generatoraccess.getEntities((Entity) null, voxelshape.a());
        Iterator iterator = list.iterator();

        while (iterator.hasNext()) {
            Entity entity = (Entity) iterator.next();
            double d0 = VoxelShapes.a(EnumDirection.EnumAxis.Y, entity.getBoundingBox().d(0.0D, 1.0D, 0.0D), voxelshape, -1.0D);
    ...
    public static boolean a(VoxelShape voxelshape, EnumDirection enumdirection) {
        VoxelShape voxelshape1 = VoxelShapes.a(voxelshape, enumdirection);
    ...
    public static MovingObjectPosition a(IBlockData iblockdata, World world, BlockPosition blockposition, Vec3D vec3d, Vec3D vec3d1) {
        MovingObjectPosition movingobjectposition = VoxelShapes.a(iblockdata.g(world, blockposition), vec3d, vec3d1, blockposition);

        if (movingobjectposition != null) {
            MovingObjectPosition movingobjectposition1 = VoxelShapes.a(iblockdata.j(world, blockposition), vec3d, vec3d1, blockposition);
    ...
    public String m() {
        if (this.name == null) {
            this.name = SystemUtils.a("block", (MinecraftKey) Block.REGISTRY.b(this));
        }
    ...
    public static void t() {
        ...
        a("water", (Block) (new BlockFluids(FluidTypes.c, Block.Info.a(Material.WATER).a().b(100.0F).d())));
        a("lava", (Block) (new BlockFluids(FluidTypes.e, Block.Info.a(Material.LAVA).a().c().b(100.0F).a(15).d())));
        ...
        a("oak_door", (Block) (new BlockDoor(Block.Info.a(Material.WOOD, block1.m).b(3.0F).a(SoundEffectType.a))));
        ...
        a("oak_pressure_plate", (Block) (new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, Block.Info.a(Material.WOOD, block1.m).a().b(0.5F).a(SoundEffectType.a))));
        a("spruce_pressure_plate", (Block) (new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, Block.Info.a(Material.WOOD, block2.m).a().b(0.5F).a(SoundEffectType.a))));
        a("birch_pressure_plate", (Block) (new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, Block.Info.a(Material.WOOD, block3.m).a().b(0.5F).a(SoundEffectType.a))));
        a("jungle_pressure_plate", (Block) (new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, Block.Info.a(Material.WOOD, block4.m).a().b(0.5F).a(SoundEffectType.a))));
        a("acacia_pressure_plate", (Block) (new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, Block.Info.a(Material.WOOD, block5.m).a().b(0.5F).a(SoundEffectType.a))));
        a("dark_oak_pressure_plate", (Block) (new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, Block.Info.a(Material.WOOD, block6.m).a().b(0.5F).a(SoundEffectType.a))));
        ...
        a("oak_fence", (Block) (new BlockFence(Block.Info.a(Material.WOOD, block1.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        ...
        a("oak_fence_gate", (Block) (new BlockFenceGate(Block.Info.a(Material.WOOD, block1.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        ...
        a("spruce_fence_gate", (Block) (new BlockFenceGate(Block.Info.a(Material.WOOD, block2.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("birch_fence_gate", (Block) (new BlockFenceGate(Block.Info.a(Material.WOOD, block3.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("jungle_fence_gate", (Block) (new BlockFenceGate(Block.Info.a(Material.WOOD, block4.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("acacia_fence_gate", (Block) (new BlockFenceGate(Block.Info.a(Material.WOOD, block5.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("dark_oak_fence_gate", (Block) (new BlockFenceGate(Block.Info.a(Material.WOOD, block6.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("spruce_fence", (Block) (new BlockFence(Block.Info.a(Material.WOOD, block2.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("birch_fence", (Block) (new BlockFence(Block.Info.a(Material.WOOD, block3.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("jungle_fence", (Block) (new BlockFence(Block.Info.a(Material.WOOD, block4.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("acacia_fence", (Block) (new BlockFence(Block.Info.a(Material.WOOD, block5.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("dark_oak_fence", (Block) (new BlockFence(Block.Info.a(Material.WOOD, block6.m).a(2.0F, 3.0F).a(SoundEffectType.a))));
        a("spruce_door", (Block) (new BlockDoor(Block.Info.a(Material.WOOD, block2.m).b(3.0F).a(SoundEffectType.a))));
        a("birch_door", (Block) (new BlockDoor(Block.Info.a(Material.WOOD, block3.m).b(3.0F).a(SoundEffectType.a))));
        a("jungle_door", (Block) (new BlockDoor(Block.Info.a(Material.WOOD, block4.m).b(3.0F).a(SoundEffectType.a))));
        a("acacia_door", (Block) (new BlockDoor(Block.Info.a(Material.WOOD, block5.m).b(3.0F).a(SoundEffectType.a))));
        a("dark_oak_door", (Block) (new BlockDoor(Block.Info.a(Material.WOOD, block6.m).b(3.0F).a(SoundEffectType.a))));
    ...
    public static class Info {
        ...
        public static Block.Info a(Block block) {
            Block.Info block_info = new Block.Info(block.material, block.m);

            block_info.a = block.material;
            block_info.g = block.strength;
            block_info.f = block.durability;
            block_info.c = block.o;
            block_info.h = block.j;
            block_info.e = block.g;
            block_info.a = block.material;
            block_info.b = block.m;
            block_info.d = block.stepSound;
            block_info.i = block.n();
            block_info.j = block.p;
            return block_info;
        }
